...
review, native Help/About resources, and 1009 English-source localization entries
...
input/display, installed-app and release gates are not yet accepted. Continue the remaining launch/CLI/Keychain and diagnostic-presentation localization
audit, plus interactive window/menu/file-panel acceptance. Profile/history/import text
