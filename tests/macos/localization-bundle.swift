...
let fullscreenFailure = String(localized:"desktop.fullscreen.open.failure.detail",defaultValue:"Full screen could not be opened: \(documentName)",bundle:bundle)
precondition(fullscreenFailure == "Full screen could not be opened: " + documentName)
let optionAlias = String(localized:"invocation.help.alias",defaultValue:" (alias: \(documentName))",bundle:bundle)
precondition(optionAlias == " (alias: " + documentName + ")")
let optionDefault = String(localized:"invocation.help.default",defaultValue:" [default: \(documentName)]",bundle:bundle)
precondition(optionDefault == " [default: " + documentName + "]")
let commandUsage = String(localized:"invocation.help.usage",defaultValue:"Usage: \(documentName)",bundle:bundle)
precondition(commandUsage == "Usage: " + documentName)
