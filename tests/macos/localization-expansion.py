...
parser.add_argument("--prefix", action="append", help="Catalog prefix to expand (repeatable). Defaults to authentication, credentials, trust, actions, settings, profiles, history, listener, documents and endpoint errors.")
...
prefixes = tuple(args.prefix or ["authentication.", "credentials.", "trust.", "action.", "settings.", "profiles.", "history.", "listener.", "document.", "endpoint.issue.", "import.source."])
