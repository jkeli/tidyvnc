...
prefixes = tuple(args.prefix or ["authentication.", "credentials.", "trust.", "action.", "settings.", "profiles.", "history.", "listener.", "document.", "import.defaults.", "app.", "desktop.", "information.", "endpoint.issue.", "import.source.", "connection.recovery.", "clipboard.recovery.", "tunnel.error."])
