...
func schemaAndPrecedence() async throws {
  ...
  let malformed: [(Data,NativeStorageError)] = [
    (try envelope(schema:13),.futureSchema), (try envelope(schema:9),.unsupportedFields),
  ...
  try check(object["schema"] as? Int == 12 && object["historyState"] as? String == "currentXDG","schema 12 marker in the history transaction")
